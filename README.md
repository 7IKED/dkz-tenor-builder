...
### TEN0R™ Claw Builder — NEO™ (Smart/Pico+) und TRON™ (Full/Open+) Modi, GitHub Search, MCP Points, Playbook Personalisierung
...
![Lines](https://img.shields.io/badge/Lines-534-ffb800?style=for-the-badge)
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-tenor-builder.git

# Oeffnen
cd dkz-tenor-builder
